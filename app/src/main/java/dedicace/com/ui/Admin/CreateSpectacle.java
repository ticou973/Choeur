...
public class CreateSpectacle extends AppCompatActivity implements DialogNewSSFragment.DialogNewSSListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button addTitres = findViewById(R.id.btn_add_titres);
        Button addConcerts = findViewById(R.id.btn_add_concerts);
        Button createSpectacleInDb = findViewById(R.id.btn_create_spectacle_db);
        nomSpectacle=findViewById(R.id.et_nom_spectacle);
        Button selectChorale = findViewById(R.id.btn_select_chorale_spectacle);
        ...
        createSpectacleInDb.setOnClickListener(view -> {
        ...
        if(resultCode== Activity.RESULT_OK) {
            ...
            if (requestCode == REQUEST_CODE_B) {
                ...
                if(data!=null){
                    ...
                    List<String> datesStr = data.getStringArrayListExtra("datesconcerts");
